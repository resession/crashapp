...
export default {
    ...
    methods: {
        ...
        submitComment(token){
            this.$http.post('/comment/hash/text', {token, key: this.$store.getters.isLoggedIn ? this.$store.getters.account.key : '', text: this.commentData, id: this.datahash.hash}).then(res => {
                this.commentData = ''
